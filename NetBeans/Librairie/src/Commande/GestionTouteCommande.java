...
public class GestionTouteCommande extends javax.swing.JFrame {
    ...
    private final Client monClient;
     ...
     * @param monClient
     */
    public GestionTouteCommande(GestionCommande gc, Client monClient) throws SQLException {
...
//            };
    ...
    private void jButtonModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModifierActionPerformed
        ...
        try {
            Gnc = new GestionNumCommande(this, cmd);
...
//                    new GestionTouteCommande(new GestionCommande(),monClientTest).setVisible(true);
//                } catch (SQLException ex) {
